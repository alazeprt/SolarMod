...
import static com.alazeprt.block.vertical_solar_panel.LIGHT;
import static com.alazeprt.block.vertical_solar_panel.WATERLOGGED;

public class vertical_solar_panel_entity extends BlockEntity {
    public vertical_solar_panel_entity(BlockPos pos, BlockState state){
        super(Register.VERTICAL_SOLAR_PANEL_ENTITY, pos, state);
    }
    static int light = 0;
    public static void tick(World world, BlockPos pos, BlockState state, vertical_solar_panel_entity be) {
